...
public class UnitTest {
    ...
    public void testErrorFormat() {
        ...
        check_equals(mes, Util.error("testParseUrl error", buf, 0));
        ...
        mes =
                "56789B123456789C123456789D123456789E123456789F123456789G123456789H123456\n" +
                        "....................................^";
        check_equals(mes, Util.error("testParseUrl trim right and left", buf, 0));
        ...
        mes =
                "123456789A123456789B123456789C123456789D123456789E123456789F123456789G12\n" +
                        ".....^";
        check_equals(mes, Util.error("testParseUrl trim right", buf, 0));
        ...
        mes =
                "9C123456789D123456789E123456789F123456789G123456789H123456789I123456789J\n" +
                        "..............................................................^";
        check_equals(mes, Util.error("testParseUrl trim left", buf, 10));
    }
    ...
    void check_equals(Object supposed2be, Object is) {
