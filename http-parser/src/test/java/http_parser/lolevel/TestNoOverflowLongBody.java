...
public class TestNoOverflowLongBody {
    ...
    public void testNoOverflowLongBody(http_parser.ParserType type, int len) {
    ...
    ByteBuffer getBytes(http_parser.ParserType type, int length) {
    ...
    public void test() {
        ...
        testNoOverflowLongBody(http_parser.ParserType.HTTP_REQUEST, 1000);
        testNoOverflowLongBody(http_parser.ParserType.HTTP_REQUEST, 100000);
        testNoOverflowLongBody(http_parser.ParserType.HTTP_RESPONSE, 1000);
        testNoOverflowLongBody(http_parser.ParserType.HTTP_RESPONSE, 100000);
    }
